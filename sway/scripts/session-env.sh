...
# :: doom/modules/gitlab/core.el reads GITLAB_* via getenv at Emacs startup, and Emacs
...
# :: absent the file the session still starts and gitlab/core.el uses its defaults.
